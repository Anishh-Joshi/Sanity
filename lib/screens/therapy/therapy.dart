...
class Therapy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final TherapyModel therapy = ModalRoute.of(context)!.settings.arguments as TherapyModel ;
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Row(
                              children: [
                                CircleAvatarCustom(url: state.therapydetails!.byDoctor!.profileImgUrl!, radius: height*0.02),
                                const SizedBox(width: 10,),
                                Text(
                                  'Dr.${state.therapydetails!.byDoctor!.fullName.toString()}',
                                  style: Theme.of(context)
                                      .textTheme
                                      .headline4!
