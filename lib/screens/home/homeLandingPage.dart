...
//       const WritePage(),
//       user.isDoctor!? AppointmentInformation(user:user,): const DoctorsPage(),
//       const MessagePage(),
//     ];
//   }
...
//         inactiveColorPrimary: CupertinoColors.systemGrey,
//       ),
//      user.isDoctor!?PersistentBottomNavBarItem(
...
//      final UserInfoModel user = ModalRoute.of(context).settings.arguments;
